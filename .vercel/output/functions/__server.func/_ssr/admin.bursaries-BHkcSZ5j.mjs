...
import { a as generateBroadsheetPdf, C as COUNTY_NAMES, K as KENYA_COUNTIES, g as generateBursaryPdf, b as generateConfirmationLetter } from "./bursary-pdf-5PuWsLMy.mjs";
...
import { D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle, e as DialogDescription, f as DialogFooter } from "./dialog-PwpLs1Wj.mjs";
...
import { G as GraduationCap, a as MapPin, ao as FileSpreadsheet, b as Mail, O as Search, ap as SquareCheckBig, X, j as CircleCheck, as as Trash2, aC as Eye, aD as Pencil, e as Send, ae as ChevronRight, aE as Clock3, A as ArrowLeft, y as School, aF as CircleX, D as Download, w as Users, aa as Banknote, aG as ArrowUpDown, C as ChevronDown, aj as FileText, p as Calendar } from "../_libs/lucide-react.mjs";
...
function AdminBursariesPage() {
  ...
  const [editBusy, setEditBusy] = reactExports.useState(false);
  const load = async () => {
    const {
      data,
      error
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return rows.filter((r) => {
      ...
      if (!q) return true;
      return r.student_name.toLowerCase().includes(q) || (r.school_name || "").toLowerCase().includes(q) || (r.canonical_school_name || "").toLowerCase().includes(q) || (r.ward || "").toLowerCase().includes(q) || (r.reference || "").toLowerCase().includes(q) || (r.guardian_name || "").toLowerCase().includes(q) || (r.school_county || "").toLowerCase().includes(q) || (r.school_sub_county || "").toLowerCase().includes(q);
    });
  }, [rows, filter, search]);
...
This cannot be undone.`)) return;
  ...
  const startEditing = (r) => {
    setEditFields({
      ...
      ward: r.ward || "",
      amount_requested: r.amount_requested !== null && r.amount_requested !== void 0 ? String(r.amount_requested) : "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { title: "Bursary Applications", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: isChecked ? "bg-primary/5" : "hover:bg-muted/30", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-end gap-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: () => {
                  setSelected(r);
                  startEditing(r);
                }, title: "Edit", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4 text-primary" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!selected, onOpenChange: (o) => {
    ...
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto", children: selected && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-5 w-5 text-gold" }),
          "Edit Application: ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 gap-4 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-student-name", children: "Student Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "edit-student-name", value: editFields.student_name, onChange: (e) => setEditFields((prev) => ({
            ...prev,
            student_name: e.target.value
          })) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-status", children: "Status (Approval)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: editFields.status, onValueChange: (val) => setEditFields((prev) => ({
            ...prev,
            status: val
          })), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-status", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "pending", children: "Pending" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "reviewing", children: "Reviewing" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "approved", children: "Approved" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-school-name", children: "School (as typed by applicant)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "edit-school-name", value: editFields.school_name, onChange: (e) => setEditFields((prev) => ({
            ...prev,
            school_name: e.target.value
          })), list: "school-suggestions" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-canonical-school-name", children: "Standardized School Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "edit-canonical-school-name", value: editFields.canonical_school_name, onChange: (e) => setEditFields((prev) => ({
            ...prev,
            canonical_school_name: e.target.value
          })), list: "school-suggestions", placeholder: "e.g. KANGA HIGH SCHOOL" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-school-category", children: "Category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: editFields.school_category, onValueChange: (val) => setEditFields((prev) => ({
            ...prev,
            school_category: val
          })), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-school-category", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "C1", children: "C1 — National" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "C2", children: "C2 — Extra-County" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "C3", children: "C3 — County" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "C4", children: "C4 — Sub-County / Day" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Private", children: "Private" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "TVET", children: "TVET / Vocational" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "University", children: "University" })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-school-county", children: "School County" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: editFields.school_county, onValueChange: (val) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-school-county", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: COUNTY_NAMES.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: c }, c)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-school-sub-county", children: "School Sub-county" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: editFields.school_sub_county, onValueChange: (val) => setEditFields((prev) => ({
            ...prev,
            school_sub_county: val
          })), disabled: !editFields.school_county, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-school-sub-county", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: (KENYA_COUNTIES[editFields.school_county] || []).map((sc) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: sc, children: sc }, sc)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-ward", children: "Ward" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: editFields.ward, onValueChange: (val) => setEditFields((prev) => ({
            ...prev,
            ward: val
          })), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "edit-ward", className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 sm:col-span-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-amount-requested", children: "Amount Awarded (KSh)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { id: "edit-amount-requested", type: "number", min: "0", step: "500", value: editFields.amount_requested, onChange: (e) => setEditFields((prev) => ({
            ...prev,
            amount_requested: e.target.value
          })) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2 sm:gap-2 pt-4 border-t", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setIsEditing(false), disabled: editBusy, children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "hero", onClick: saveEditApplication, disabled: editBusy, children: editBusy ? "Saving..." : "Save Changes" })
      ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "gap-2 sm:gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: () => startEditing(selected), className: "gap-1.5", children: [
