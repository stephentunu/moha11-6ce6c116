...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DYTelXhS.mjs");
...
const manifest = {
  "27aeb153a917bb953e3f5a8b11c0ab7125188fc155f7e1d966f8c50023e304b5": {
    ...
    importer: () => import("./sms.functions-DuySKeWS.mjs")
  },
  "27f8cd9ab7ac84567f04dc5052c10bbeacba76f5b59d1ba5c3a99c55c25f96b5": {
    functionName: "sendBursarySms_createServerFn_handler",
    importer: () => import("./bursary.functions-D5agfGG2.mjs")
  },
  "91470433042195b042731f475f5e0bf41b319f444101ffebc960505bee251237": {
    functionName: "simpleSignUp_createServerFn_handler",
    importer: () => import("./simple-auth.functions-ChcjI5pk.mjs")
  },
  "629de4d32d45e43757545161a70c3bae7f7d9e46f5b35000932ec239a7baf732": {
    functionName: "simpleSignIn_createServerFn_handler",
    importer: () => import("./simple-auth.functions-ChcjI5pk.mjs")
  },
  "1bead37f43c67904514299ecab03298164d39c52f096ee6c7e44fafecda291d5": {
    functionName: "validateSession_createServerFn_handler",
    importer: () => import("./simple-auth.functions-ChcjI5pk.mjs")
  },
  "49d710a1dc764df44b030b7dca0edb793cfc5b2d813132b82f01efd79893c2b6": {
    functionName: "simpleSignOut_createServerFn_handler",
    importer: () => import("./simple-auth.functions-ChcjI5pk.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CiepFxU2.mjs").then((n) => n.r),
